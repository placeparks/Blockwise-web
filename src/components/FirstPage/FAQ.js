  ...
  <div className="row g-0">
    ...
    <div className="col-md-8">
      <div className="card-body" style={{textAlign:"left"}}>
        <h5 className="card-title" style={{fontWeight:"700"}}>(1) Why is blockchain considered trustworthy?</h5>
...
<h5 className="card-title" style={{fontWeight:"700"}}>(2) What is consortium algorithm?</h5>
...
<h5 className="card-title" style={{fontWeight:"700"}}>(3) What are the key features of blockchain?</h5>
...
<h5 className="card-title" style={{fontWeight:"700"}}>(4) What are the various types of blockchain?</h5>
...
<h5 className="card-title" style={{fontWeight:"700"}}>(5) What are the business benefits of blockchain integration?</h5>
