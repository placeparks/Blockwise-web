...
export default function Solutions() {
    ...
    return (
      <div>
    <h1 style={{fontWeight:"700", paddingBottom:"1%"}}>Blockchain Solutions for the Enterprise</h1>
    <h3 style={{paddingBottom:"1%"}}>Industries and Businesses adopting the next wave of digital era.</h3>
    <div className="row row-cols-1 row-cols-md-4 g-4">
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec1.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Financial Sector</h5>
  ...
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec2.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Insurance</h5>
  ...
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec3.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Healthcare</h5>
  ...
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec4.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Supply Chain</h5>
  ...
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec5.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Agriculture</h5>
  ...
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec6.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Transportation</h5>
  ...
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec7.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Retail</h5>
  ...
  <div className="col">
    <div className="card h-100">
      <img src="./First-page/solution-section/rec8.png" className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title" style={{fontWeight:"700"}}>Blockchain in Energy: Oil and Gas</h5>
