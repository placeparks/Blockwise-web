...
export default function Types(){
    return(
        ...
        <h6 style={{paddingBottom:"3%"}}>Looking to boost your fundraising initiative? Our blockchain experts can help! We'll create a custom token solution for you using ERC, TRC, or BEP token standards. You choose the blockchain and we'll handle the rest.
...
So why settle for traditional fundraising when you can tokenize your assets and raise funds faster and more efficiently? Contact us today to learn more about how we can help you spruce up your fundraising with a custom token solution.</h6>
        ...
        <h2 style={{paddingBottom:"3%"}}>Types of Tokens We Provide:</h2>
