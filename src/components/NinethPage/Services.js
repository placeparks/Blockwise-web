...
export default function Services(){
    ...
    return(
        <div>
            ...
            <p style={{textAlign:"center", paddingBottom:"2%"}}>Looking for a team that can help you generate crypto coins and tokens with exceptional security? Look no further! Our team is dedicated to providing high-quality services that give you total control and complete ease of use.
