export default function Company(){
    return(
        <div>
                <div className="card mb-5 w-100" style={{background:"transparent", border:"none"}}>
